#packetAnalyzer.py: This Python program will analyze each packet received by the
#host machine and print out the contents of its Ethernet, IP, and TCP/UDP headers
#to the console. The script will differentiate the packet's protocol as either TCP
#or UDP and print their respective headers to the console.
