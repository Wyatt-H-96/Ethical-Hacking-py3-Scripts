#macSniffer.py: This Python script is designed to mimic the sniffing capabilities
#of Wireshark. This script will sniff all packets sent and received by the host
#machine and will print to the console the packet's destination and source MAC
#address and protocol being used.
